...
```{r 2-6-collapsed, fig.cap= "Pandilleros, Colapsados por Grupo Ilícito"}
g %>%
  contract(.,
...
```{r 2-6-importacion, fig.cap= "Cuadro de diálogo para importar un archivo CSV (1 de 2)"}
knitr::include_graphics("images/02-07-01.png")
```

```{r 2-6-importacion2, fig.cap= "Cuadro de diálogo para importar un archivo CSV (2 de 2)"}
...
```{r 2-6-importacion4, fig.cap= "Cuadro de diálogo para importar un archivo CSV"}
