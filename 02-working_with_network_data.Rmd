...
```{r bienvenida, out.width="100%", fig.cap = "Menú de Bienvenida en Gephi"}
...
```{r les-mis, out.width="100%", fig.cap = "Datos Les Misrables Cargados"}
...
```{r overview, out.width = "100%", fig.cap =  "Gephi: Vista General"}
...
```{r apariencia, out.width = "100%", fig.cap =  "Gephi: Apariencia"}
...
```{r color-unique, out.width = "100%", fig.cap =  "Nodos y Aristas con Colores Únicos"}
...
```{r size-unique, out.width = "100%", fig.cap =  "Nodos con Tamaño Único"}
...
```{r color-partition, out.width = "100%", fig.cap =  "Nodos Coloreados por Atributos Categoriales."}
...
```{r size-ranking, out.width = "100%", fig.cap =  "Nodos Dimensionados por Variable Continua."}
...
```{r force-atlas, out.width = "100%", fig.cap =  "Gráfico dibujado con Force Atlas"}
...
```{r expansion, out.width = "100%", fig.cap =  "Gráfico dibujado con Force Atlas y Expandido"}
...
```{r degree, out.width = "100%", fig.cap =  "Ejecutando Estadística de Grado"}
...
```{r filter, out.width = "100%", fig.cap =  "Filtrando por Grado"}
...
```{r grafo, out.width = "100%", fig.cap =  "Ventanilla de Grafo"}
...
```{r data-lab, out.width = "100%", fig.cap =  "Laboratorio de datos, a la izquierda la Tabla de Nodos y a la derecha la Tabla de Aristas"}
...
```{r nodes-table, out.width = "100%", fig.cap =  "Laboratorio de datos, Tabla de Nodos"}
...
```{r edges-table, out.width = "100%", fig.cap =  "Laboratorio de datos, Tabla de Aristas"}
...
```{r lower-bar, out.width = "100%", fig.cap =  "Laboratorio de datos, Opciones"}
...
```{r preview, out.width = "100%", fig.cap =  "Previsualización"}
