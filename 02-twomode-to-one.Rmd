...
```{r projected1, fig.cap = "Red proyectada, persona-a-persona"}
...
```{r projected2, fig.cap = "Red proyectada, evento-a-evento"}
...
```{r instalados, out.width="75%", fig.cap = "Plugins instalados"}
...
```{r disponibles, out.width="75%", fig.cap = "Plugins disponibles"}
...
```{r multimode, out.width="75%", fig.cap = "Pestaña MultiMode Projection"}
...
```{r importar, out.width="75%", fig.cap = "Cuadro de Diálogo: Importar Hoja de Cálculo"}
...
```{r nodes, out.width="75%", fig.cap = "Informe de Importación para Lista de Nodos"}
...
```{r aristas, out.width="75%", fig.cap = "Informe de Importación para Lista de Aristas"}
...
```{r bip-1, out.width="75%", fig.cap = "Datos Bipartitas Desde Lista de Aristas"}
...
```{r bip-3, out.width="75%", fig.cap = "Red Bipartita Filtrada, Partición = Person"}
...
```{r bip-4, out.width="75%", fig.cap = "Enlaces de Persona-a-Persona"}
...
```{r bip-5, out.width="75%", fig.cap = "Enlaces de Evento-a-Evento"}
