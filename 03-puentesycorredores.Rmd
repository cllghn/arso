...
```{r 3,  fig.cap="Red Huelga: puntos de corte, bicomponentes y centralidad de puente"}
...
```{r 4,  fig.cap="Red Huelga: puntos de corte, bicomponentes y puntajes de corretaje G&F"}
knitr::include_graphics(path = "images/03-11-04.png")
```



```{r 5,  fig.cap="Red Huelga: puntos de corte, bicomponentes y la autonomía de Burt"}
