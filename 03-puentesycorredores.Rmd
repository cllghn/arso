...
```{r holes, fig.cap = "Red social hipotética donde a se encuentra entre tres agujeros estructurales"}
...
```{r triads, fig.cap = "Cuatro tipos de triadas"}
par(mfrow=c(1, 4))
...
::::{.row}
::::{.lcolumn-50}
```{r practice, fig.cap = "Red pequeña"}
...
```{r autonomy, fig.cap = "Red con nodos dimensionados por autonomía"}
