...
```{r 3-4-edgebetween, fig.cap = "Representación esquemática de una red con dos comunidades densamente enlazadas entre sí por vínculos con alta intermediación."}
...
```{r 3-4-triads, fig.cap = "Cuatro tipos de tríadas"}
par(mfrow = c(1, 4))
