...
```{r, fig.cap = "Nodos dimensionados por cercanía"}
plot.igraph(g,
            vertex.border.color = "black",
            layout = coords,
            vertex.label = NA,
...
```{r, fig.cap = "Nodos dimensionados por eigenvector"}
plot.igraph(g,
            vertex.border.color = "black",
            layout = coords,
            vertex.label = NA,
...
```{r, fig.cap = "Nodos dimensionados por intermediación"}
plot.igraph(g,
            vertex.border.color = "black",
            layout = coords,
            vertex.label = NA,
...
```{r, fig.cap = "Nodos dimensionados por grado"}
plot.igraph(g,
            vertex.border.color = "black",
            layout = coords,
            vertex.label = NA,
...
```{r, fig.cap = "Nodos coloreados por atributo"}
...
```{r, fig.cap = "Red no dirigida (izquierda) y red dirigida (derecha)"}
