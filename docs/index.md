---
title: "Análisis de Redes Sociales Oscuras"
...
Este manual electrónico le enseñará los conceptos basicos del ARSo y su aplicación en diversas areas. 
...
:::{.boxed}
**El material contenido en este manual se realizó con el propósito de revisión y discusión entre colegas para para su posterior aplicación  y no necesariamente refleja las opiniones del Departamento de Marina (en inglés Department of the Navy)  o del Departamento de Defensa (en inglés Department of Defense) de los Estados Unidos y la Escuela Superior de Guerra - Escuela de Post Grado del Ejército de Perú.**
:::
