...
En la red estrella la centralización de grado es 1.0 (ver ecuación \@ref(eq:grados)). Por consiguiente, de manera matemática asumimos que los nodos en este gráfico convergen alrededor de un actor central.
