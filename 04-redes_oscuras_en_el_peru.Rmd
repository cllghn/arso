...
```{r 4-1-dimensions, fig.cap = "Dimensiones de Organizaciones"}
...
data.frame("Tipo" = c("Cadena", "Estrella", "Malla"),
           ...
           "Dibujo" = c("images/04-cade2a.png", "images/04-estrella2.png", "images/04-malla2.png")) %>%
  dplyr::mutate(Dibujo = sprintf("![%s](%s)", "", Dibujo)) %>%
  pander::pander()
```
...
```{r 4-1-mix, fig.cap = "Red hipotética, mezcla de cadenas, estrellas y mallas", fig.height = 12}
