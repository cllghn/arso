...
```{r 2-5-combined, echo = FALSE, fig.cap = "Múltiples Relaciones"}
data.frame(
...
data.frame(
  ...
  row_spec(1:6, color= "red", bold = TRUE) %>%
  row_spec(7, color= "#018571", bold = TRUE)
```
...
```{r 2-5-apiladas, echo = FALSE, fig.cap = "Relaciones Apiladas"}
data.frame(
...
```{r 2-5-agregadas, echo = FALSE, fig.cap = "Relaciones Agregadas"}
data.frame(
...
```{r 2-5-recombinar, echo = FALSE, fig.cap = "Relaciones Recombinadas"}
data.frame(
  from = c("A", "D", "F"),
  to   = c("B", "E", "G")
  ) %>%
...
```{r 2-5-aristas, fig.cap = "Importar lista de aristas"}
knitr::include_graphics("images/02-06-01_aristas.png")
```

```{r 2-5-importacion, fig.cap = "Reporte de Importación"}
...
```{r 2-5-apilada, fig.cap = "Red apilada de datos Monasterio de Sampson"}
...
```{r 2-5-positivos, fig.cap = "Enlaces positivos de la red Monasterio de Sampson"}
