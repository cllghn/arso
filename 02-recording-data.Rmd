...
```{r botones, fig.cap = "Botones en Gephi"}
...
```{r globales, fig.cap = "Pestaña de Controles Globales en Gephi"}
knitr::include_graphics("images/01-botones_gephi2.png")
```

```{r globales2, fig.cap = "Pestaña de Control de Aristas"}
...
```{r globales3, fig.cap = "Panel de Control de Etiquetas en Gephi"}
...
```{r importacion, fig.cap = "Cuadro de Diálogo de Importación"}
...
```{r rol, fig.cap = "Red Koschade, Color de Nodos = Rol"}
